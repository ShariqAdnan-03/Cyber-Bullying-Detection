...
if __name__ == "__main__":
    # 1. Load your dataset (check the filename!)
    print("Loading data...")
    df = pd.read_csv('cyberbullying_tweets.csv') # Change this to your actual filename
    
    # 2. Run the modeling
    print("Running Topic Modeling... this might take a second.")
    results = Topic_modeling(df)
